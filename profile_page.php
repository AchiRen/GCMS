...
if (isset($_SESSION['user_id'])) {
    ...
    $query = "SELECT first_name, last_name, email_address, phone_number, physical_address, next_of_kin, kin_phone_number, postal_address, 
    username, password, role FROM admin WHERE username = :userId";
...
<head>
    ...
    <script src="profile_java.js"></script>
</head>
<body>
    <header>
        <div class="logosec">
        ...
        <div class="profile-container">
            ...
            <div id="profile-details">
                ...
                <div class="profile-details-item">
                    ...
                    <span id="postal_address"><?php echo isset($userData['postal_address']) ? $userData['postal_address'] : ''; ?></span>
                    <input type="text" id="edit-postal_address" style="display: none;">
                    <button class="edit-button" onclick="editField('postal-address')">Edit</button>
                    <button class="save-button" onclick="saveField('postal_address')">Save</button>
                </div>
                <div class="profile-details-item">
                ...
                <div class="profile-details-item">
                    <label>Role:</label>
                    <span id="role"><?php echo isset($userData['role']) ? $userData['role'] : ''; ?></span>
                    <input type="text" id="edit-role" style="display: none;">
                    <button class="edit-button" onclick="editField('role')">Edit</button>
                    <button class="save-button" onclick="saveField('role')">Save</button>
                </div>
